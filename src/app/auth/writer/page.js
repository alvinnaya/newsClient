    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if(data.token){
          ...
          Cookies.set("jwt-token", JSON.stringify(data),{expires:1})
          router.push('/writer')
        }else{
...
<div className="mx-auto max-w-screen-xl px-8 py-32 sm:px-12 lg:px-16">
  <div className="mx-auto max-w-lg">
    ...
    <form
      action=""
      className="mb-0 mt-12 space-y-8 rounded-xl border-2 border-current shadow-brutalism-b p-8 sm:p-12 lg:p-16"
    >
      <p className="text-center text-lg font-bold">Sign in to your account</p>
      ...
      <div>
        ...
        <div className="relative">
          <input
            type="username"
            className="w-full rounded-lg border-current border p-4 pe-12 text-neutralSecondary1"
