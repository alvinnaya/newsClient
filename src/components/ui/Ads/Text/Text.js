...
function Text(props) {
    ...
    return (
      ...
      <p style={{zIndex:`${props.zIndex}`,fontSize:`2rem`,gridColumnStart: `${props.style.colStart}`,gridColumnEnd: `${props.style.colEnd}`,gridRowStart: `${props.style.rowStart}`,gridRowEnd: `${props.style.rowEnd}`}} 
