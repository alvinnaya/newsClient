...
function SubHeading(props) {
    ...
    return (
      ...
      <h2 style={{zIndex:`${props.zIndex}`,fontSize:`3rem`,gridColumnStart: `${props.style.colStart}`,gridColumnEnd: `${props.style.colEnd}`,gridRowStart: `${props.style.rowStart}`,gridRowEnd: `${props.style.rowEnd}`}} 
