...
function HeadingText(props) {
    ...
    return (
            ...
            <>
                ...
                ref={editorRef} onFocus={handleFocus} onBlur={HandleContentChange} dangerouslySetInnerHTML={{ __html: props.Text }} contentEditable={true} className="block box-border w-full h-full leading-[1.1] text-[2.15rem] focus:outline-none focus:border-zinc-300 border-transparent rounded-lg p-2 border-2 ">
